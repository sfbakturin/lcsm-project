...
const std::unordered_map< unsigned, sim::support::Ref< sim::Component > > &sim::SimCircuit::Pins() const noexcept
{
	return m_pin;
}
...
sim::Constant *sim::SimCircuit::RegisterConstant(sim::Width width, std::uint64_t value)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(constant);
	return constant;
}
...
sim::Ground *sim::SimCircuit::RegisterGround(sim::Width width)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(ground);
	return ground;
}
...
sim::Power *sim::SimCircuit::RegisterPower(sim::Width width)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(power);
	return power;
}
...
sim::Pin *sim::SimCircuit::RegisterPin(bool output, sim::Width width)
{
	...
	m_pin[m_globalId++] = sim::support::Ref< sim::Component >(pin);
...
sim::Splitter *sim::SimCircuit::RegisterSplitter(sim::Width widthIn, std::size_t widthOut)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(splitter);
	return splitter;
}
...
sim::Transistor *sim::SimCircuit::RegisterTransistor(sim::TransistorType type)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(transistor);
	return transistor;
}
...
sim::TransmissionGate *sim::SimCircuit::RegisterTransmissionGate()
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(transmissionGate);
...
sim::Clock *sim::SimCircuit::RegisterClock(unsigned highDuration, unsigned lowDuration, unsigned phaseOffset)
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(clock);
	return clock;
}
...
sim::Button *sim::SimCircuit::RegisterButton(bool activeOnPress)
{
	...
	m_io[m_globalId++] = sim::support::Ref< sim::Component >(button);
	return button;
}
...
sim::Digit *sim::SimCircuit::RegisterDigit(bool hasDecimalPoint)
{
	...
	m_io[m_globalId++] = sim::support::Ref< sim::Component >(digit);
	return digit;
}
...
sim::Probe *sim::SimCircuit::RegisterProbe()
{
	...
	m_io[m_globalId++] = sim::support::Ref< sim::Component >(probe);
	return probe;
}
...
sim::Wire *sim::SimCircuit::RegisterWire()
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(wire);
	return wire;
}
...
sim::Tunnel *sim::SimCircuit::RegisterTunnel()
{
	...
	m_comp[m_globalId++] = sim::support::Ref< sim::Component >(tunnel);
	return tunnel;
}
