...
namespace lcsm
{
	namespace model
	{
		...
		const char *KindToKeyword(LCSMFileKind kind) noexcept;
		LCSMFileKind IsKeyword(const char *s) noexcept;
		LCSMFileKind IsKeyword(const std::string &s) noexcept;
		LCSMFileKind IsKeyword(char c) noexcept;
		LCSMFileKind BoolToKeyword(bool b) noexcept;
	}	 // namespace model
}	 // namespace lcsm
