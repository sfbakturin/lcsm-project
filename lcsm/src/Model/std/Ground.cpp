...
lcsm::model::Ground::Ground(lcsm::label_t name, lcsm::Width width) : lcsm::Component(name), m_width(width) {}
...
lcsm::ComponentType lcsm::model::Ground::componentType() const noexcept
{
	return lcsm::ComponentType::Ground;
}

void lcsm::model::Ground::connect(lcsm::portid_t portId, lcsm::Component *circuit)
{
...
void lcsm::model::Ground::disconnect(lcsm::Component *) noexcept
{
	// Do nothing.
}
...
void lcsm::model::Ground::connect(lcsm::Component *circuit)
{
	connect(lcsm::model::Ground::Port::Wiring, circuit);
}

lcsm::Component *lcsm::model::Ground::byPort(lcsm::portid_t portId) noexcept
{
...
lcsm::portid_t lcsm::model::Ground::findPort(const lcsm::Component *circuit) const noexcept
{
...
void lcsm::model::Ground::copy(lcsm::Component *circuit, lcsm::model::LCSMBuilder &builder) const
{
